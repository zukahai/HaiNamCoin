...
export class FontsService {
    ...
    async create(createFontDto: CreateFontDto): Promise<Font> {
        ...
        font.price = createFontDto.price;
        font.price_license = createFontDto.priceLicense;
        font.user = await this.userService.findOne(createFontDto.userId);
    ...
    async findOne(id: number) {
        ...
        const price_license =
            (font.price_license + InfomaintionProvider.profit * font.price_license) / (1 - percentage_fee);
        let transactions = [];
