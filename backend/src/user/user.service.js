    ...
    UserService.prototype.create = function (createUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userModel.create(createUserDto)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.userModel.update(updateUserDto, { where: { id: id } })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.findOne(id)];
                    case 3: return [2 /*return*/, _a.sent()];
                    case 4: throw new common_1.HttpException('User not found', common_1.HttpStatus.NOT_FOUND);
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.userModel.destroy({ where: { id: id } })];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw new common_1.HttpException('User not found', common_1.HttpStatus.NOT_FOUND);
